...
$ReportPath = Join-Path -Path $PSScriptRoot -ChildPath "MFAUsers.csv"
Write-Host "Report is in $ReportPath"
...
$Report | Sort-Object UserPrincipalName | Export-CSV -Encoding UTF8 -NoTypeInformation $ReportPath
